...
(function (e, t) {
  function _(e) {
    ...
    i.addEventListener ? (i.removeEventListener("DOMContentLoaded", A, !1), v.ready()) : i.readyState === "complete" && (i.detachEvent("onreadystatechange", A), v.ready());
      ...
      O = {};v.fn = v.prototype = { constructor: v, init: function (e, n, r) {
    ...
    var t,
      ...
      P = /([A-Z])/g;v.extend({ cache: {}, deletedIds: [], uuid: 0, expando: "jQuery" + (v.fn.jquery + Math.random()).replace(/\D/g, ""), noData: { embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0 }, hasData: function (e) {
      ...
      V = v.support.getSetAttribute;v.fn.extend({ attr: function (e, t) {
    ...
    function nt(e, t, n, r) {
      ...
      ot = { children: !0, contents: !0, next: !0, prev: !0 };v.fn.extend({ find: function (e) {
      var t,
          n,
          r,
          i,
    ...
    v.fn[e] = function (n, r) {
      ...
      Ct = lt(i),
      kt = Ct.appendChild(i.createElement("div"));Nt.optgroup = Nt.option, Nt.tbody = Nt.tfoot = Nt.colgroup = Nt.caption = Nt.thead, Nt.th = Nt.td, v.support.htmlSerialize || (Nt._default = [1, "X<div>", "</div>"]), v.fn.extend({ text: function (e) {
    ...
    var e, t;v.uaMatch = function (e) {
      ...
      Jt = ["Webkit", "O", "Moz", "ms"],
      Kt = v.fn.toggle;v.fn.extend({ css: function (e, n) {
    ...
    v.cssHooks[e + t] = { expand: function (n) {
      ...
      an = /^(?:select|textarea)/i;v.fn.extend({ serialize: function () {
    ...
    if (typeof e != "string" && En) return En.apply(this, arguments);if (!this.length) return this;var i,
        ...
        o,
        u = this,
        a = e.indexOf(" ");return a >= 0 && (i = e.slice(a, e.length), e = e.slice(0, a)), v.isFunction(n) ? (r = n, n = t) : n && typeof n == "object" && (s = "POST"), v.ajax({ url: e, type: s, dataType: "html", data: n, complete: function (e, t) {
    ...
    v[n] = function (e, r, i, s) {
      ...
      _n = /\?/,
      Dn = /(=)\?(?=&|$)|\?\?/,
      Pn = v.now();v.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
    ...
    if (e.crossDomain) {
      var n,
          r = i.head || i.getElementsByTagName("head")[0] || i.documentElement;return { send: function (s, o) {
    ...
    if (!n.crossDomain || v.support.cors) {
      var r;return { send: function (i, s) {
          var o,
              u,
...
//# sourceMappingURL=jquery-1.8.3.min-compiled.js.map