...
var TimeLine = function () {
    ...
    var Minute_SVGMove = function (trans) {
        ...
        for (var i = 0; i < MinutesShowCount; i++) {
            ...
            for (var j = 0; j < 12; j++) {
                ...
                //根据时间 初始化 基础svg
                var SVG_Day = '   <g class="tick_Year_One" transform="translate(' + Minute_Trans + ')" >' + '<rect class="DayRect Btn_MinuteRect" x="0.2" y="0" width="12.5" height="55" value="' + DayTimeStr + '">' + '<title>' + DayTimeStr + '</title>' + '</rect>' + '<line class="tick_dot" x1="12" x2="12" y1="0" y2="52"></line>' + '</g>';
                //SVG_Hour = SVG_Hour + Data_SVG + SVG_Day + TimeGar;

                SVG_Hour = SVG_Hour + Data_SVG + SVG_Day;
                if (Minute_Trans == "75" || Minute_Trans == "215") {
                    SVG_Hour = SVG_Hour + '<line x1="' + Minute_Trans + '" x2="' + Minute_Trans + '" y1="40" y2="55" class="tick_10DayLine"' + ' ></line>';
                }
                // 加5min
        ...
        for (var i = 0; i < m_MinuteModeData.length; i++) {
            ...
            if (IsDataShowList[i] == true) {
                ...
                if (Ishow) {
                    IS_ShowTag = true;
                    //若该图层显示 则为蓝色
                    DateRect = '<rect class="Rect_Data_Show" x="-0.2" y="' + Rect_Y + '" width="12.7" height="' + rect_Height + '" ></rect>' + '<line x1="0" x2="12.5" y1="' + Rect_Y + '" y2="' + Rect_Y + '" class="Data_tick_Line"></line>' + '<line x1="0" x2="12.5" y1="' + RectLineEnd + '" y2="' + RectLineEnd + '" class="Data_tick_Line"></line>';
                } else {
                    IS_ShowTag = true;
                    //不显示则为灰色
    ...
    var Day_SVGMove = function (trans) {
        ...
        for (var i = 0; i < DayShowCount; i++) {
            ...
            //月开始 绘制
            var SVG_Month = '  <g class="tick_Total_Year" transform="translate(' + Month_Trans + ')">' + '<line x1="0" x2="0" y1="0" y2="80" class="tick_Line"></line>';
            //每一天循环
            for (var j = 0; j < TimeDateCount; j++) {
                ...
                if (DayTimeStr == DateShowNowStr) {
                    TimeGar = '<g id="guitarpick" class="SVG_guitarpick"  ' + ' transform="translate(' + (Day_Trans - 8) + ',-10)">' + '<title>' + DateShowNowStr + '</title>' + '<path d="' + 'M3.658 0.743C1.775 0.743 0.25 3.793 0.25 7.555l0 21.272l7.302 15.711l7.302 15.711l7.302 -15.711l7.302 -15.711l0 -21.272c0 -3.763 -1.526 -6.813 -3.408 -6.813l-22.392 0z' + '"></path>' + '<rect width="3" height="20" x="9" y="11" ></rect>' + '<rect width="3" height="20" x="14" y="11" ></rect>' + '<rect width="3" height="20" x="19" y="11" ></rect>' + '</g>';
                }
                //根据时间 初始化 基础svg
                /*      + ' onclick="javascript:' + self.DayRectOnClick(evt, ' + ShowYear + ', ' + ShowMonth + ', ' + j + ') + '"   >'*/
                var SVG_Day = '   <g class="tick_Year_One" transform="translate(' + Day_Trans + ')" >' + '<rect class="DayRect Btn_DayRect" x="0.2" y="0" width="12.5" height="55" value="' + ShowYear + '-' + (parseInt(ShowMonth) + 1) + '-' + parseInt(j + 1) + '">' + '<title>' + ShowYear + '-' + (parseInt(ShowMonth) + 1) + '-' + parseInt(j + 1) + '</title>' + '</rect>' + '<line class="tick_dot" x1="12" x2="12" y1="0" y2="52"></line>' + '</g>';
                ...
                if (Day_Trans == "62.5" || Day_Trans == "125" || Day_Trans == "187.5" || Day_Trans == "250" || Day_Trans == "312.5" || Day_Trans == "375") {
                    SVG_Month = SVG_Month + '<line x1="' + Day_Trans + '" x2="' + Day_Trans + '" y1="40" y2="55" class="tick_10DayLine"' + ' ></line>';
                }
            }
    ...
    var Month_SvgMove = function (tarnsform) {
        ...
        for (var i = 0; i < MonthShowCount; i++) {
            ...
            for (var Month = 0; Month < 12; Month++) {
                ...
                var MonthSVG = '<g class="tick_Year_One" transform="translate(' + TransMonth + ')">' + '<rect x="0.2" y="0" width="12.5" height="55" class="DayRect Btn_MonthRect" value="' + ShowDateStr + '">' + '<title>' + ShowDateStr + '</title>' + '</rect>' + '<line class="tick_dot" x1="12" x2="12" y1="0" y2="52"></line>' + '</g>';
                //若显示月为当前月
