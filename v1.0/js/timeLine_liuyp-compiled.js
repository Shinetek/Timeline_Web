...
(function (global) {
    ...
    TimeLine.YearModel.prototype = {
        ...
        btnClickGetYear: function (event) {
            ...
            //重新设置
            var SELECTDATE = moment.utc([m_Year, parseInt(self.DateInfo.MONTHSHOW - 1), parseInt(self.DateInfo.DAYSHOW), parseInt(self.DateInfo.HOURSHOW), parseInt(self.DateInfo.MINUTESHOW), 0]);
            //刷新显示 对外 显示
    ...
    TimeLine.MonthModel.prototype = {
        ...
        btnClickGetMonth: function (event) {
            ...
            //重新设置
            var SELECTDATE = moment.utc([_YearStr, parseInt(_MonthStr - 1), parseInt(self.DateInfo.DAYSHOW), parseInt(self.DateInfo.HOURSHOW), parseInt(self.DateInfo.MINUTESHOW), 0]);
    ...
    TimeLine.DayModel.prototype = {
        ...
        drag: function (tarnsform) {
            ...
            for (var i = 0; i < this.DAYMODEVAR.DAYShowCount; i++) {
                ...
                for (var j = 0; j < TimeDateCount; j++) {
                    ...
                    var SVG_Day = '   <g class="tick_Year_One" transform="translate(' + Day_Trans_min + ')" >' + '<rect class="DayRect Btn_DayRect" x="0.2" y="0" width="12.5" height="55" value="' + DayTimeStr + '">' + '<title>' + DayTimeStr + '</title>' + '</rect>' + '<line class="tick_dot" x1="12" x2="12" y1="0" y2="52"></line>' + '</g>';
        ...
        btnClickGetDay: function (event) {
            ...
            //重新设置
            var SELECTDATE = moment.utc([_YearStr, parseInt(_MonthStr - 1), _DayStr, parseInt(self.DateInfo.HOURSHOW), parseInt(self.DateInfo.MINUTESHOW), 0]);
            ...
            for (var i = 0; i < this.MINUTEMODEVAR.MinuteShowCount; i++) {
                ...
                for (var j = 0; j < 60; j++) {
                    ...
                    if (DateShowNowStr === MinuteTimeStr && is_GutiarFlag === false) {
                        is_GutiarFlag = true;
                        TimeGar = '<g id="guitarpick" class="SVG_guitarpick" ' + ' transform="translate(' + (Minute_Trans - 8) + ',-10)">' + '<title>' + MinuteTimeStr + '</title>' + '<path d="' + 'M3.658 0.743C1.775 0.743 0.25 3.793 0.25 7.555l0 21.272l7.302 15.711l7.302 15.711l7.302 -15.711l7.302 -15.711l0 -21.272c0 -3.763 -1.526 -6.813 -3.408 -6.813l-22.392 0z' + '"></path>' + '<rect width="3" height="20" x="9" y="11" ></rect>' + '<rect width="3" height="20" x="14" y="11" ></rect>' + '<rect width="3" height="20" x="19" y="11" ></rect>' + '</g>';
                    }

                    //根据时间 初始化 基础svg
                    var SVG_Day = '<g class="tick_Year_One" transform="translate(' + Minute_Trans + ')" >' + '<rect class="DayRect Btn_MinuteRect" x="0.2" y="0" width="12.5" height="55" value="' + MinuteTimeStr + '">' + '<title>' + MinuteTimeStr + '</title>' + '</rect>' + '<line class="tick_dot" x1="12" x2="12" y1="0" y2="52"></line>' + '</g>';
                    ...
                    if (Minute_Trans % (12.5 * 5) === 0) {
                        if (Minute_Trans % (12.5 * 5 * 2) === 0) {
                            SVG_Hour = SVG_Hour + '<line x1="' + Minute_Trans + '" x2="' + Minute_Trans + '" y1="20" y2="55" class="tick_10DayLine"' + ' ></line>';
                        } else {
...
//# sourceMappingURL=timeLine_liuyp-compiled.js.map